# Operator Quickstart — cloud-itonami-isic-6312

Shortest path from clone to a verified local dry-run for **ISIC 6312** (`cloud-itonami-isic-6312`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6312.git
